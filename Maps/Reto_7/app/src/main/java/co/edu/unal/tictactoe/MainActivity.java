...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (btnOnline != null) {
            btnOnline.setOnClickListener(v -> {
                try {
                    ...
                    Toast.makeText(this, "Error al abrir: " + e, Toast.LENGTH_LONG).show();
                }
            });
        }
        ...
        if (btnNew != null) btnNew.setOnClickListener(this::onNewGameClicked);
        if (btnDiff != null) btnDiff.setOnClickListener(v -> showDifficultyDialog());
        ...
        // Runnable para la jugada de CPU
        mComputerMoveTask = () -> {
        ...
        if (savedInstanceState == null) {
            ...
            int diffOrd = savedInstanceState.getInt(
                    STATE_DIFFICULTY, TicTacToeGame.DifficultyLevel.Expert.ordinal());
            ...
            if (!mGameOver && mCpuMovePending) {
                ...
                mainHandler.postDelayed(mComputerMoveTask, 600);
            }
        }
    ...
    private void onCellClicked(int location) {
        ...
        mAndroidThinking = true;
        mCpuMovePending = true;
        mainHandler.postDelayed(mComputerMoveTask, 1000);
    }
    ...
    protected void onPause() {
        super.onPause();
        if (mComputerMoveTask != null) {
            mainHandler.removeCallbacks(mComputerMoveTask);
        }
